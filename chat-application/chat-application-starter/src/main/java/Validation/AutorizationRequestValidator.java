...
public @interface AutorizationRequestValidator {
    String message() default "Phone and prefix must be both present or both absent.";
    Class<?>[] groups() default {};
    Class<? extends Payload>[] payload() default {};
    
    static class AutorizationRequestProvider  implements ConstraintValidator<AutorizationRequestValidator, Object> {
